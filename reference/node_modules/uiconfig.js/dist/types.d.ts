...
export type OnClickReturnType = (void | (() => any) | {
    action?: (() => any);
    undo?: (() => any);
    redo?: (() => any);
});
export interface UiObjectConfig<T = any, TType extends UiObjectType = UiObjectType, TTarget = any> {
     ...
     * @param args
     */
    onClick?: ((...args: any[]) => OnClickReturnType) | ((...args: any[]) => Promise<OnClickReturnType>);
    /**
...
export declare function createValueUiConfig<T = any, TType extends UiObjectType = UiObjectType, TTarget = any>(config: UiObjectConfig<T, TType, TTarget>): Omit<UiObjectConfig<T, TType, TTarget>, 'value'> & {
    value: T;
};
