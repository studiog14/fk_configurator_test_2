...
var InteractionPromptPlugin_1;
import { Spherical, Vector3 } from 'three';
import { now, objectHasOwn, onChange, serialize } from 'ts-browser-helpers';
 ...
 * @category Plugins
 */
let InteractionPromptPlugin = InteractionPromptPlugin_1 = class InteractionPromptPlugin extends AViewerPluginSync {
    constructor(enabled = true) {
        ...
        this.animationPauseDuration = 6000;
        /**
         ...
         */
        this.autoStartOnObjectLoad = true;
        this.autoStartOnObjectLoadDelay = 3000;
        this.currentTime = 0;
         ...
         */
        this.pointerIcon = `<svg xmlns="http://www.w3.org/2000/svg" style="transform: translate(-50%, -25%);" xmlns:xlink="http://www.w3.org/1999/xlink" width="25" height="36">
    <defs>
    ...
    <g transform="translate(-11 -4)" fill="none" fill-rule="evenodd">
        ...
        this.onlyOnOrbitControls = true;
        this._orbitWarning = false;
        this.startAnimation = () => {
            if (!this._viewer || !this.cursorEl || this.isDisabled())
                return;
            if (this._viewer.scene.mainCamera.controls?.type !== 'OrbitControls' && this.onlyOnOrbitControls) {
                if (!this._orbitWarning)
                    console.warn('InteractionPromptPlugin requires OrbitControls, to run anyway, set onlyOnOrbitControls to false');
                this._orbitWarning = true;
                return;
            }
            if (this._viewer.scene.modelRoot.children.length === 0)
                return;
            this.currentSphericalPosition = new Spherical().setFromVector3(new Vector3().subVectors(this._viewer.scene.mainCamera.position, this._viewer.scene.mainCamera.target));
            this.cursorEl.style.opacity = '1';
            this.currentTime = 0;
            this.animationRunning = true;
            this._viewer.scene.mainCamera.setInteractions(false, InteractionPromptPlugin_1.PluginType);
        ...
        this.stopAnimation = async ({ reset = true } = {}) => {
            if (!this._viewer || !this.cursorEl)
                return; // dont check for enabled here.
            this.animationRunning = false;
            ...
            this._viewer.scene.mainCamera.setInteractions(true, InteractionPromptPlugin_1.PluginType);
        ...
        this._pointerDown = () => {
            if (this.isDisabled())
                return;
            if (this.autoStop)
                this.stopAnimation({ reset: false }); // todo dont reset only on pointer drag, not down
            this.lastActionTime = now();
        };
        this._x = 0;
        this._preFrame = async (ev) => {
            if (!this._viewer || !this.cursorEl)
                return;
...
__decorate([
    serialize(),
    uiToggle()
], InteractionPromptPlugin.prototype, "enabled", void 0);
__decorate([
    serialize(),
    uiInput()
], InteractionPromptPlugin.prototype, "animationDuration", void 0);
__decorate([
    serialize(),
    uiInput()
], InteractionPromptPlugin.prototype, "animationDistance", void 0);
__decorate([
    serialize(),
    uiInput()
], InteractionPromptPlugin.prototype, "animationPauseDuration", void 0);
__decorate([
    serialize(),
    uiInput()
], InteractionPromptPlugin.prototype, "rotationDistance", void 0);
__decorate([
    serialize(),
    uiInput()
], InteractionPromptPlugin.prototype, "yOffset", void 0);
__decorate([
    serialize(),
    uiToggle()
], InteractionPromptPlugin.prototype, "autoStart", void 0);
__decorate([
    serialize(),
    uiInput()
], InteractionPromptPlugin.prototype, "autoStartDelay", void 0);
__decorate([
    serialize(),
    uiToggle()
], InteractionPromptPlugin.prototype, "autoStop", void 0);
__decorate([
    serialize(),
    uiToggle()
], InteractionPromptPlugin.prototype, "autoStartOnObjectLoad", void 0);
__decorate([
    serialize(),
    uiToggle()
], InteractionPromptPlugin.prototype, "autoStartOnObjectLoadDelay", void 0);
__decorate([
    uiMonitor()
], InteractionPromptPlugin.prototype, "currentTime", void 0);
__decorate([
    uiMonitor()
], InteractionPromptPlugin.prototype, "lastActionTime", void 0);
__decorate([
    onChange(InteractionPromptPlugin.prototype._pointerIconChanged)
], InteractionPromptPlugin.prototype, "pointerIcon", void 0);
__decorate([
    serialize()
], InteractionPromptPlugin.prototype, "onlyOnOrbitControls", void 0);
__decorate([
    uiButton()
], InteractionPromptPlugin.prototype, "startAnimation", void 0);
__decorate([
    uiButton()
], InteractionPromptPlugin.prototype, "stopAnimation", void 0);
InteractionPromptPlugin = InteractionPromptPlugin_1 = __decorate([
    uiFolderContainer('Interaction Prompt')
], InteractionPromptPlugin);
export { InteractionPromptPlugin };
//# sourceMappingURL=InteractionPromptPlugin.js.map