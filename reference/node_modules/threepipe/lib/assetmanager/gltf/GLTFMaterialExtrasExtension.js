 ...
 */
GLTFMaterialExtrasExtension.Import = (loadConfigResources) => (parser) => ({
    ...
    afterRoot: async (result) => {
        ...
        for (const s of scenes) {
            ...
            s.traverse((obj) => {
                ...
                if (ext.alphaHash !== undefined)
                    o.alphaHash = ext.alphaHash;
                ...
                if (ext.blendSrc !== undefined)
                    o.blendSrc = ext.blendSrc;
                if (ext.blendDst !== undefined)
                    o.blendDst = ext.blendDst;
                if (ext.blendEquation !== undefined)
                    o.blendEquation = ext.blendEquation;
                if (ext.blendSrcAlpha !== undefined)
                    o.blendSrcAlpha = ext.blendSrcAlpha;
                if (ext.blendDstAlpha !== undefined)
                    o.blendDstAlpha = ext.blendDstAlpha;
                if (ext.blendEquationAlpha !== undefined)
                    o.blendEquationAlpha = ext.blendEquationAlpha;
                if (ext.blendColor !== undefined && o.blendColor !== undefined)
                    o.blendColor.setHex(ext.blendColor);
                if (ext.blendAlpha !== undefined)
                    o.blendAlpha = ext.blendAlpha;
                ...
                if ((o.userData.legacyBumpScale || assetVersion && assetVersion <= 2.0) && o?.bumpScale !== undefined && o?.bumpMap && o.defines) {
                    console.warn('MaterialManager: Old format material loaded, bump map might be incorrect.', o, o.bumpScale);
...
GLTFMaterialExtrasExtension.Export = (w) => ({
    writeMaterial(material, matDef) {
        ...
        if (material.alphaHash !== undefined)
            dat.alphaHash = material.alphaHash;
        ...
        if (material.blendSrc !== undefined)
            dat.blendSrc = material.blendSrc;
        if (material.blendDst !== undefined)
            dat.blendDst = material.blendDst;
        if (material.blendEquation !== undefined)
            dat.blendEquation = material.blendEquation;
        if (material.blendSrcAlpha !== undefined)
            dat.blendSrcAlpha = material.blendSrcAlpha;
        if (material.blendDstAlpha !== undefined)
            dat.blendDstAlpha = material.blendDstAlpha;
        if (material.blendEquationAlpha !== undefined)
            dat.blendEquationAlpha = material.blendEquationAlpha;
        if (material.blendColor !== undefined)
            dat.blendColor = material.blendColor.getHex();
        if (material.blendAlpha !== undefined)
            dat.blendAlpha = material.blendAlpha;
