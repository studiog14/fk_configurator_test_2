    ...
    const config = {
        ...
        children: [
            ...
            // },
            {
                ...
                onChange: (e) => {
                    if (e.last)
                        this.setDirty?.({ uiChangeEvent: e, refreshScene: true, frameFade: false, refreshUi: true });
                },
            },
            {
                type: 'checkbox',
    ...
    if ((this.isLine || this.isMesh) && isMesh !== false) {
        ...
        const ui = [
            ...
            } : this.material?.uiConfig,
            {
                ...
                type: 'button',
                hidden: () => !this.materials?.length || this.materials.length === 1 && [defaultMaterial, defaultLineMaterial, defaultUnlitLineMaterial].includes(this.materials[0]),
                value: () => {
