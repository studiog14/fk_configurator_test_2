import { BaseEvent, Color, IUniform, Material, MeshBasicMaterial, MeshBasicMaterialParameters, Shader, WebGLRenderer } from 'three';
 ...
 * @category Materials
 */
export declare class UnlitMaterial<TE extends IMaterialEventMap = IMaterialEventMap> extends MeshBasicMaterial<TE> implements IMaterial<TE> {
