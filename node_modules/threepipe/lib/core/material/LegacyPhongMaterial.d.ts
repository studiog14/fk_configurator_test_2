import { BaseEvent, Color, IUniform, Material, MeshPhongMaterial, MeshPhongMaterialParameters, Shader, Vector2, WebGLRenderer } from 'three';
...
export declare class LegacyPhongMaterial<TE extends IMaterialEventMap = IMaterialEventMap> extends MeshPhongMaterial<TE> implements IMaterial<TE> {
    ['constructor']: typeof LegacyPhongMaterial;
    static readonly TypeSlug = "phongmat";
    static readonly TYPE = "LegacyPhongMaterial";
    assetType: "material";
    userData: IMaterialUserData;
    readonly isLegacyPhongMaterial = true;
     ...
     */
    setValues(parameters: Material | (MeshPhongMaterialParameters & {
        type?: string;
...
//# sourceMappingURL=LegacyPhongMaterial.d.ts.map