...
import { BaseEvent, BufferGeometry, Camera, Color, IUniform, Material, Object3D, Scene, Shader, Vector2, WebGLRenderer } from 'three';
 ...
 * @category Materials
 */
export declare class LineMaterial2<TE extends IMaterialEventMap = IMaterialEventMap> extends LineMaterial<TE> implements IMaterial<TE> {
    ['constructor']: typeof LineMaterial2;
    static readonly TypeSlug = "lmat";
    static readonly TYPE = "LineMaterial2";
    assetType: "material";
    userData: IMaterialUserData;
    readonly isLineMaterial2 = true;
     ...
     */
    setValues(parameters: Material | (LineMaterialParameters & {
        type?: string;
...
export declare class MeshLineMaterial extends LineMaterial2 {
}
//# sourceMappingURL=LineMaterial2.d.ts.map