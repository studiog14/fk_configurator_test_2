import { DataTexture, DataUtils, LinearSRGBColorSpace, RGBAFormat, UnsignedByteType } from 'three';
export function dataTextureFromColor(color) {
...
export function dataTextureFromVec4(color) {
 ...
 * @param res
 */
export function halfFloatToRgbe(buffer, channels = 3, res) {
    let r, g, b, v, s;
